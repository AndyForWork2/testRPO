...
//функция обработки транзакции (без создания потока)
//extern "C"
...
//    }
//    buf[12] = 0x00;
//    //вычисляем сумму, сравниваем транзакцию с заданными данными, уменьшаем кол-во попыток
...
//функция для получения текущео Java env
...
//отцепляем указатель на текущий поток от переменной
...
//функция обработки транзакции с созданием потока
extern "C"
JNIEXPORT jboolean JNICALL

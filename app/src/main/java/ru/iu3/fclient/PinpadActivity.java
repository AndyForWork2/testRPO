...
public class PinpadActivity extends AppCompatActivity {
    ...
    protected void ShuffleKeys()
    {
        ...
        //генерируем рандомное значение
        int res = MainActivity.initRng();
        byte[] rnd = MainActivity.randomBytes(MAX_KEYS);
        for(int i = 0; i < MAX_KEYS; i++)
        {
            //меняем текст нашей кнопки и другой, предыдущей, на которой стоит нужное значение
